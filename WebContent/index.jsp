				...
				<div class="tg-banner-poststyle">
						...
						<div id="tg-post-slider" class="post-slider">
							<div class="item">
								<div class="tg-category">
									<figure><img src="img/alone.jpg" alt="image description"></figure>
							...
							<div class="item">
								<div class="tg-category">
									<figure><img src="img/calm.jpg" alt="image description"></figure>
									<div class="category-content">
										<div class="display-table">
											<div class="display-table-cell">
												<div class="post-meta">
							...
							<div class="item">
								<div class="tg-category">
									<figure><img src="img/bent.jpg" alt="image description"></figure>
									<div class="category-content">
										<div class="display-table">
											<div class="display-table-cell">
												<div class="post-meta">
							...
							<div class="item">
								<div class="tg-category">
									<figure><img src="img/hut.jpg" alt="image description"></figure>
									<div class="category-content">
										<div class="display-table">
											<div class="display-table-cell">
												<div class="post-meta">
							...
							<div class="item">
								<div class="tg-category">
									<figure><img src="img/rock.jpg" alt="image description"></figure>
									<div class="category-content">
										<div class="display-table">
											<div class="display-table-cell">
												<div class="post-meta">
					...
					<div class="post-content">
						<div class="display-table">
							<div class="display-table-cell">
								<div class="post-meta">
									<span><a href="#">RARORIBICA</a></span>
								</div>
								<div class="title">
									<h1>Our Journey <span>JOURNAL</span></h1>
								</div>
								<div class="post-meta no-padding">
									<span>
										This is our online journal that keeps all the memories we shared during our journey together in life.
									</span>
								</div>
							</div>
						</div>
